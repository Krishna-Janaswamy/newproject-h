...
1. Sign in on **Zalter Dashboard** (https://dashboard.module.com) and create your **Zalter project**.
...
```bash
NEXT_PUBLIC_ENABLE_MODULE_AUTH="true"
NEXT_PUBLIC_PROJECT_ID="<your-project-id>"
```

For more information about Zalter Authentication access https://developer.module.com.
